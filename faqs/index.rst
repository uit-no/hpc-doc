...
In order to get more information to your submitted job, you should use
this command:
...
A list of jobnames running on which node, can also be found at
`Stallo\`s
webpage <http://stallo-adm.uit.no/ganglia/addons/rocks/queue.php?c=Stallo>`_.
...
<jobid>*, does not work you should try the following command:

::

    qsig -sNULL <jobid>

This should "always" work. However if it don't work you have to contact
...
Relevant examples (also for beginning users) 
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

In addition to the generic :doc:`jobscript example <./job-script-example>`
there are application specific examples on the documentation for
